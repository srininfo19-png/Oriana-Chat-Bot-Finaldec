    ...
    <div className="min-h-screen bg-gradient-to-br from-[#004d40] via-[#00695c] to-[#b48b39] flex flex-col items-center justify-center p-4">
      ...
      <div className="absolute top-4 right-4 z-20">
        <button 
          ...
          className="text-white/80 hover:text-white text-sm bg-black/20 hover:bg-black/30 px-3 py-1 rounded-full backdrop-blur-sm transition flex items-center gap-2"
        >
